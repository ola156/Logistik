...
const Nav = () => {
  ...
  return (
    <>
      ...
      <header className="w-full bg-orange-500 px-2 py-4 shadow">
        <nav className="max-w-[90%] mx-auto ">
          <div className="flex justify-between items-center">
            ...
            <ul className="md:flex justify-between gap-10 lg:mr-25 hidden transition-colors text-white font-bold uppercase">
              <li className="hover:text-black underline-offset-3 hover:underline">
                Home
              </li>
              <li className="hover:text-black underline-offset-3 hover:underline">
                Service
        ...
        {isNavOpen && (
          <div className="fixed border-2 border-left border-l-orange-500 border-r-0 border-t-0 border-b-0 h-full w-[55%]  top-0 right-0 md:hidden block">
            <div>
              <div className=" bg-black mb-5 px-3 py-5  flex justify-between items-center">
              ...
              <ul className="flex flex-col justify-between gap-4  px-6 py-3 transition-colors text-black font-bold uppercase">
                <NavLink to="/">
